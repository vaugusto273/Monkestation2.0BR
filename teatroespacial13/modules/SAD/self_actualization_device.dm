...
/obj/machinery/self_actualization_device
	...
	icon = 'teatroespacial13/modules/SAD/icons/icons/self_actualization_device.dmi'
	icon_state = "sad_open"
...
/obj/machinery/self_actualization_device/attack_hand_secondary(mob/user)
...
/obj/machinery/self_actualization_device/RefreshParts()
	...
	for(var/datum/stock_part/micro_laser/laser in component_parts) // Laser tier increases speed, at the expense of power.
		...
		active_power_usage = 72000 / processing_time WATTS
