...
GLOBAL_LIST_INIT(traits_by_type, list(
	/atom = list(
		...
		"TRAIT_CATCH_AND_RELEASE" = TRAIT_CATCH_AND_RELEASE, // NOVA ADDITION
	),
	/atom/movable = list(
		...
		"TRAIT_IMMERSED" = TRAIT_IMMERSED, // NOVA EDIT
	...
	/datum/controller/subsystem/processing/station = list(
		...
		//"STATAION_TRAIT_NO_AIRLOCKS" = STATAION_TRAIT_NO_AIRLOCKS, ATIVE ISTO SOMENTE EM CASO DE FAZER FUNNY FUNNY no_airlocks
...
*/
	...
	/mob = list(
		...
		"TRAIT_USES_MIXSKINTONES" = TRAIT_USES_MIXSKINTONES,
		...
		"TRAIT_NO_CLONING" = TRAIT_NO_CLONING,
	...
	/obj/item/organ/internal/liver = list(
		...
		"TRAIT_CORONER_METABOLISM" = TRAIT_CORONER_METABOLISM, // Nova edit enables this again
