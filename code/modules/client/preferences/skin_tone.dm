...
// // /datum/preference/choiced/mix_skin_tone/init_possible_values()
// // 	return GLOB.skin_tones
...
// /datum/preference/choiced/mix_skin_tone/compile_constant_data()
// 	var/list/data = ..()
...
// /datum/preference/choiced/mix_skin_tone/apply_to_human(mob/living/carbon/human/target, value)
// 	target.skin_tone = value
