...
/obj/machinery/bluespace_miner/RefreshParts()
	...
	for(var/datum/stock_part/manipulator/manipulator in component_parts) // original servo_part --> manipulator
		processing_speed -= (manipulator.tier * (0.5 SECONDS))
...
/* Teatro espacial edit (it is only for CE)
