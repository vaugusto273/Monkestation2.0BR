...
/obj/item/claymore/dragonslayer
	...
	var/roll_stamcost = 20 // Was 10 which only allowed fourteen dashes on Nova, somehow was able to do thirty here
	/// how far do we roll?
	var/roll_range = 3
...
/obj/item/claymore/dragonslayer/attack_secondary(atom/target, mob/living/user, clickparams)
	return SECONDARY_ATTACK_CONTINUE_CHAIN

/obj/item/claymore/dragonslayer/afterattack_secondary(atom/target, mob/living/user, clickparams)
