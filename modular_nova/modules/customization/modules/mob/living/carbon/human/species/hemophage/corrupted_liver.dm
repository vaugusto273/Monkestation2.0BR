...
/datum/component/organ_corruption/internal/liver/register_signals_on_organ_owner(obj/item/organ/implanted_organ, mob/living/carbon/receiver)
	if(!..())
		return
...
/datum/component/organ_corruption/liver/UnregisterFromParent()
	...
	var/obj/item/organ/internal/parent_liver = parent
 ...
 */
/datum/component/organ_corruption/internal/liver/proc/handle_drink(mob/living/target_mob, obj/item/reagent_containers/cup/container, mob/living/user)
	SIGNAL_HANDLER
	...
	body.vomit(vomit_type = HEMOPHAGE_VOMIT_FLAGS, lost_nutrition = 0, distance = 1, purge_ratio = HEMOPHAGE_VOMIT_PURGE_RATIO)
