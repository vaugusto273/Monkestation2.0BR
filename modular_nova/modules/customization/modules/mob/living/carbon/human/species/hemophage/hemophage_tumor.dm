...
/obj/item/organ/internal/heart/hemophage/on_insert(mob/living/carbon/tumorful, special, movement_flags)
	. = ..()
...
/obj/item/organ/internal/heart/hemophage/on_remove(mob/living/carbon/tumorless, special = FALSE)
	. = ..()
