import { ReactNode } from 'common/react';
import {
  Box,
  Button,
  Dropdown,
...
const VisualizationToggle = (props: VisualizationToggleProps) => {
  ...
  return (
    <Tooltip
      content="Toggle a visualization of shuttle frames you can use to construct a shuttle. Red tiles indicate frame parts built in invalid areas, or parts of suitable areas that need frame parts built on them."
    >
      <Box inline>
        Visualization:
        <Button
...
const ShuttleConstruction = () => {
  const [shuttleDirection, setShuttleDirection] = useLocalState<Direction>(
    Direction.NORTH,
  );
